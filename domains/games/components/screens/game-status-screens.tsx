            ...
            <div className="min-h-screen bg-black flex items-center justify-center p-4">
                <div className="max-w-md text-center space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground mb-2">{game.rejectionReason || 'This game did not match the article themes.'}</p>
                        <p className="text-muted-foreground text-sm">You can regenerate and try again.</p>
                    </div>
                    <button
            ...
            <div className="min-h-screen bg-black flex items-center justify-center p-4">
                <div className="max-w-md text-center space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">This game needs to be approved before you can play. Review it and confirm it matches the original article.</p>
                    </div>
                    <button
                        onClick={() => window.history.back()}
                        className="px-6 py-3 bg-purple-600 hover:bg-purple-500 text-white rounded-lg font-semibold transition-colors"
